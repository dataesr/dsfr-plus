    ...
    <Container fluid className="fr-mb-5w">
      ...
      <Row gutters>
        <Col xs={12}>
          ...
          <Text>
            Les champs permettent à un utilisateur d'entrer du contenu et
        ...
        <Col xs={12}>
          ...
          <Text>
            Le DSFR recommande d’ajouter un texte d’aide sous le libellé afin de
            faciliter la saisie.{" "}
          </Text>
        ...
        <Col xs={12}>
          ...
          <Text>
            Le champs “zone de texte” est un champ de saisie libre, qui accepte
            plus d’une ligne de contenu (texte ou/ et nombre). Il reprend le
            style du champ simple et augmente uniquement sa hauteur.
          </Text>
          <Playground code={textarea} scope={{ TextArea }} />
        </Col>
        <Col xs={12}>
          <Title as="h2" look="h4">
            Utilisation en mode controlé
          </Title>
          <Text>
            Le composant Champ de saisie est un élément <code>TextInput</code>{" "}
            classique. Vous pouvez gérer le champs de saisie depuis votre
            composant en utilisant <code>value</code> et <code>onChange</code>.
          </Text>
          <Playground code={controlled} scope={{ TextInput, useState }} />
        </Col>
        <Col xs={12}>
          <Title as="h2" look="h4">
            Contrôle de l'état `valid` et `error`
          </Title>
          <Text>
            Si vous n'utilisez pas les paramètres d'état <code>message</code> et{" "}
            <code>messageType</code>, la validation automatique du navigateur
            est utilisée.
          </Text>
          <Playground code={autoValidation} scope={{ TextInput }} />
          <Text>
            Vous pouvez la rendre inopérante avec la props{" "}
            <code>disableAutoValidation</code>.
          </Text>
